...
import { buildPromptGeneratorGraph } from './prompt-generator.graph';
...
@Injectable()
export class PromptGeneratorService implements OnModuleInit {
  private graph!: ReturnType<typeof buildPromptGeneratorGraph>;

  constructor(private threadService: ThreadService) {}

  onModuleInit() {
    this.graph = buildPromptGeneratorGraph(this.threadService.getCheckpointer());
  }
